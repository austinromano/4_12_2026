  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden relative">
      ...
      <div className="flex flex-col items-center justify-start shrink-0 w-[60px] pt-4 pb-2 z-20 gap-4">
        {/* Ghost logo */}
        <motion.svg onClick={() => setVizModeIdx((i) => (i + 1) % vizModes.length)} width="44" height="44" viewBox="0 0 20 22" fill="none" className="shrink-0 cursor-pointer" style={{ filter: 'drop-shadow(0 0 4px rgba(0,255,200,0.3))' }} animate={{ y: [0, -8, 0] }} transition={{ duration: 2.5, repeat: Infinity, ease: 'easeInOut' }}>
